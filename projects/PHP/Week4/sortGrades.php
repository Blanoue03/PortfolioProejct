...
<h2> sortGrades.php - Programmed by Brandon Lanoue</h2>
<?php
...
print("<br/>After sorting the array by value using arsort,
the array looks like this:<br/>");
arsort($grades);
foreach ($grades as $student => $grade) {
    echo"$student: $grade <br/>";
}
print("<br/>After sorting the array by key using ksort(),
the array looks like this:<br/>");
ksort($grades);
foreach ($grades as $student => $grade) {
    echo"$student: $grade <br/>";
